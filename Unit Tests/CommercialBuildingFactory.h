...
public:
    std::unique_ptr<BuildingComponent> createOffice(int numEmployees, const std::string& businessType, const std::string& district, int quality, int x = 0, int y = 0) override;
