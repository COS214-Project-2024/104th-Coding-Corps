...
std::unique_ptr<BuildingComponent> CommercialBuildingFactory::createMall(int numShops, const std::string& businessType, int numBusinesses, const std::string& district, int quality, int x, int y) {
    std::mt19937 gen(static_cast<unsigned>(std::time(0))); 
    std::uniform_int_distribution<> positionDist(0, 159);
    x = positionDist(gen);
    y = positionDist(gen);
...
std::unique_ptr<BuildingComponent> CommercialBuildingFactory::createShop(int shopSize, const std::string& businessType, const std::string& district, int quality, int x, int y) {
    std::mt19937 gen(static_cast<unsigned>(std::time(0))); 
    std::uniform_int_distribution<> positionDist(0, 159);
    x = positionDist(gen);
    y = positionDist(gen);
