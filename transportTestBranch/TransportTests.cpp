...
TEST_CASE("Transport Class Tests") {
    // Create instances of House and Factory with x and y coordinates defined
    ...
    SUBCASE("Calculate Distance") {
        // Test calculating distance between two buildings
    ...
    SUBCASE("Choose Strategy - Walking") {
        // Test choosing strategy for short distance (1 km or less)
    ...
    SUBCASE("Choose Strategy - Car") {
        // Test choosing strategy for medium distance (1 km to 10 km)
    ...
    SUBCASE("Complete Travel") {
        ...
        // Check the traffic manager's behavior
...
TEST_CASE("TrafficManager Tests") {
    ...
    // Create shared pointers for House and Factory with x and y coordinates defined
